...
const packages = [
	...
	{ name: '@gitlens/hosting-integrations', srcDir: 'packages/integrations', dest: 'hosting-integrations' },
	{ name: '@gitlens/hosting-github', srcDir: 'packages/git-github', dest: 'hosting-github' },
