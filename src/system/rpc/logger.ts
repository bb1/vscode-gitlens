 ...
 *
 * Example prefixes:
 * - `host(gitlens.views.graph|5cf1bc7c)` — host-side logger for the Commit Graph webview
 * - `client(gitlens.views.commitDetails|4103a120)` — client-side logger inside Commit Details
 */
